...
```{r}
COLOR_ALL <- "#8c8c8c"
COLOR_MALE <- rgb(0, 0, 255, maxColorValue = 255)
COLOR_FEMALE <- rgb(255, 64, 64, maxColorValue = 255)
COLOR_YOUNG <- rgb(255, 215, 0, maxColorValue = 255)
COLOR_MIDDLE <- rgb(0, 201, 87, maxColorValue = 255)
COLOR_OLD <- rgb(153, 50, 204, maxColorValue = 255)
COLOR_EMP <- rgb(255, 128, 0, maxColorValue = 255)
COLOR_UMP <- rgb(0, 245, 255, maxColorValue = 255)
COLOR_NLF <- rgb(255, 0, 255, maxColorValue = 255)
...
df_node_feature_a <-
  ...
  mutate(
    ...
    #   grepl(pattern = "S1A1", x = node_label) ~ COLOR_MALE_YOUNG,
    #   grepl(pattern = "S1A2", x = node_label) ~ COLOR_MALE_MIDDLE,
    #   grepl(pattern = "S1A3", x = node_label) ~ COLOR_MALE_OLD,
    #   grepl(pattern = "S2A1", x = node_label) ~ COLOR_FEMALE_YOUNG,
    #   grepl(pattern = "S2A2", x = node_label) ~ COLOR_FEMALE_MIDDLE,
    #   grepl(pattern = "S2A3", x = node_label) ~ COLOR_FEMALE_OLD
    # )
  ) %>%
  select(
    node_label,
...
COLOR_MIDDLE <- rgb(0, 201, 87, maxColorValue = 255)
COLOR_OLD <- rgb(153, 50, 204, maxColorValue = 255)
COLOR_NO_CHILD <- rgb(139, 62, 47, maxColorValue = 255)
COLOR_WITH_CHILD <- rgb(127, 255, 212, maxColorValue = 255)
COLOR_EMP <- rgb(255, 128, 0, maxColorValue = 255)
COLOR_UMP <- rgb(0, 245, 255, maxColorValue = 255)
COLOR_NLF <- rgb(255, 0, 255, maxColorValue = 255)
...
- https://chart-studio.plotly.com/~vimchiz/40/#/
